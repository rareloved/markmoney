		...
		if (dateArray[i]){
			tds[i].onclick = function () {
				if (calendar.dateControl){
					...
					//depends on jquery
					$(calendar.dateControl).trigger("keyup");
				}
...
Calendar.prototype.changeShow = function(){
	var popuControl = this.dateControl;
	var dateControl = popuControl;
	var xy = this.getAbsPoint(popuControl);
	this.panel.style.left = xy.x + "px";
	this.panel.style.top = (xy.y + dateControl.offsetHeight) + "px";
}
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:99999;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:225px;">');
